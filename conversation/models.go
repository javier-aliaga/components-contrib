...
const (
	...
	envClaudeCodeModel  = "CLAUDECODE_MODEL"
)
...
const (
	...
	DefaultClaudeCodeModel  = "claude-sonnet-4-20250514"
)
...
func GetClaudeCodeModel(metadataValue string) string {
	return getModel(envClaudeCodeModel, DefaultClaudeCodeModel, metadataValue)
}
